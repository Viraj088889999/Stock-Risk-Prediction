...
The chart below illustrates which input features contributed the most to the Random Forest model's predictions. Understanding feature importance helps explain how the model makes decisions.

![Feature Importance](05_Feature_Importance.png.png)
...
The screenshot below shows the prediction generated by the trained Support Vector Machine (SVM) model. Based on the latest processed stock market data, the model classifies the next trading day's risk level into one of the predefined categories: **Low**, **Medium**, or **High**.

![Final Prediction](06_Final_Prediction.png.png)
---
##  Business Insights
